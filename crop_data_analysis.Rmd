...
\
The original dataset and detailed description can be found at: https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=3210035901. However, the subsetted version by the Skills Network Labs available at: https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-RP0203EN-SkillsNetwork/labs/Practice%20Assignment/Annual_Crop_Data.csv will be used for this demonstration
...
In this dataset, there are four types of crops (Barley, Canola, Rye and Wheat). For the puporose of this exercise, we will subset the data to contain only Barley for three years (1965 - 1967)
